...
@Service
public class CardAsyncTaskService{
...
//        System.out.println(redisTemplate.opsForHash().size("bbb"));
        ...
        System.out.println("线程" + Thread.currentThread().getName() + " 设备号:" + device + " Get result score use time:" + useTime + " cardScore：" + cardScore + " save redis key：");
        return new AsyncResult<>(cardScore);
    }
